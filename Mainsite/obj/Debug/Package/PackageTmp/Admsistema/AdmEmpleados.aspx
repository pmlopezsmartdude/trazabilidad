<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdmEmpleados.aspx.cs" Inherits="Mainsite.Admsistema.AdmEmpleados" %>
...
<asp:TabContainer ID="Tabcontainer1" runat="server" ActiveTabIndex="0" Font-Names="Century Gothic" Font-Size="Small" style="height:80%;">
 ...
 <asp:GridView ID="GridView" runat="server" AutoGenerateColumns="False">
            <Columns>
              <asp:BoundField DataField="EmpNombre" HeaderText="Nombre" />
              <asp:BoundField DataField="EmpApellido" HeaderText="Apellido" />
              <asp:BoundField DataField="EmpCargo" HeaderText="Cargo" />
              <asp:BoundField DataField="EmpCodigo" HeaderText="Edad" />
            </Columns>
          </asp:GridView>
  ...
  <tr>
   ...
   <td><asp:HyperLink ID="NuevoCargo" runat="server" EnableViewState="False" 
           Font-Size="X-Small">Crear nuevo</asp:HyperLink></td>
 </tr>
  <tr>
    <td>Codigo</td>
    <td>:</td>
